import{r as g,A as e,w as c,H as t,I as i,x as o}from"./index-CiXcBVMD.js";const K=()=>{const n=(r,l)=>{const s=new KeyboardEvent(l,{key:r,bubbles:!0,cancelable:!0});window.dispatchEvent(s)},L=()=>{n("ArrowRight","keydown")},d=()=>{n("ArrowRight","keyup")},f=()=>{n("ArrowLeft","keydown")},a=()=>{n("ArrowLeft","keyup")},m=()=>{n("w","keydown")},h=()=>{n("w","keyup")},y=()=>{n("z","keydown")},p=()=>{n("z","keyup")},D=()=>{n("ArrowDown","keydown")},w=()=>{n("ArrowDown","keyup")},P=()=>{n(" ","keydown")},C=()=>{n(" ","keyup")},x=()=>{n("Shift","keydown")},v=()=>{n("Shift","keyup")},u=g.useRef(null);return g.useEffect(()=>{const r=u.current;if(!r)return;const l=s=>{s.touches.length>1&&s.preventDefault()};return r.addEventListener("touchstart",l,{passive:!1}),()=>{r.removeEventListener("touchstart",l)}},[]),e(t,{ref:u,direction:"column",css:o`
        /* position: absolute; */
        /* width: 50wh; */
        /* max-width: 100dvw; */
