  ...
  return (
    <>
      ...
      <Flex
        ...
        `}
      > 
        <Flex css={css`justify-content: space-between; `}>
          <Text>Room</Text>
          <Button 
...
const MobileButton = () => {
  ...
  return (
    ...
    >
      <Flex>
        <Flex css={css`align-items: center; margin: 1rem;`}>
          {/* Hold */}
          <Button
            onMouseDown={holdKeydownDispatch}
            onMouseUp={holdKeyupDispatch}
            onTouchStart={holdKeydownDispatch}
            onTouchEnd={holdKeyupDispatch}
            variant="classic">
        ...
        <Flex direction="column" css={css` `}>
          <Flex css={css`justify-content: space-between; margin-bottom: 1rem;`}>
            {/* rotateLeft */}
            <Button
              onMouseDown={rotateLeftKeydownDispatch}
              onMouseUp={rotateLeftKeyupDispatch}
              onTouchStart={rotateLeftKeydownDispatch}
              onTouchEnd={rotateLeftKeyupDispatch}
              variant="classic">
            ...
            {/* rotateRight */}
            <Button
              onMouseDown={rotateRightKeydownDispatch}
              onMouseUp={rotateRightKeyupDispatch}
              onTouchStart={rotateRightKeydownDispatch}
              onTouchEnd={rotateRightKeyupDispatch}
              variant="classic">
          ...
          <Flex >
            {/* moveLeft */}
            <Button
              onMouseDown={moveLeftKeydownDispatch}
              onMouseUp={moveLeftKeyupDispatch}
              onTouchStart={moveLeftKeydownDispatch}
              onTouchEnd={moveLeftKeyupDispatch}
              variant="classic" css={css`margin-right: 1rem;`}>
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.84182 3.13514C9.04327 3.32401 9.05348 3.64042 8.86462 3.84188L5.43521 7.49991L8.86462 11.1579C9.05348 11.3594 9.04327 11.6758 8.84182 11.8647C8.64036 12.0535 8.32394 12.0433 8.13508 11.8419L4.38508 7.84188C4.20477 7.64955 4.20477 7.35027 4.38508 7.15794L8.13508 3.15794C8.32394 2.95648 8.64036 2.94628 8.84182 3.13514Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
            </Button>

            {/* softDrop */}
            <Button
              onMouseDown={softDropKeydownDispatch}
              onMouseUp={softDropKeyupDispatch}
              onTouchStart={softDropKeydownDispatch}
              onTouchEnd={softDropKeyupDispatch}
              variant="classic">
            ...
            {/* moveRight */}
            <Button
              onMouseDown={moveRightKeydownDispatch}
              onMouseUp={moveRightKeyupDispatch}
              onTouchStart={moveRightKeydownDispatch}
              onTouchEnd={moveRightKeyupDispatch}
              variant="classic" css={css`margin-left: 1rem;`}>
        ...
        <Flex  css={css`align-items: center; margin: 1rem;`}>
          {/* hardDrop */}
          <Button
            onMouseDown={hardDropKeydownDispatch}
            onMouseUp={hardDropKeyupDispatch}
            onTouchStart={hardDropKeydownDispatch}
            onTouchEnd={hardDropKeyupDispatch}
            variant="classic">
