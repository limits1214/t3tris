    ...
    >
      <Dialog.Trigger>
        <Button
          ...
          `}
        >
          #{idx + 1} {gameTypeMap(gameResult.gameType)}
        </Button>
      </Dialog.Trigger>

      <Dialog.Content>
        <Dialog.Title>
          #{idx + 1} {gameTypeMap(gameResult.gameType)} Result
        </Dialog.Title>
